...
OPENWEATHERMAP_API_KEY = "da4a9f0745f4c85447105d421ee798b6"
...
def get_weather(location: str) -> dict:
    ...
    try:
         ...
         weather_description = data["lives"][0]["weather"]
         temperature = data["lives"][0]["temperature"]
         humidity = data["lives"][0]["humidity"]
         wind_speed = data["lives"][0]["windpower"]

         return {
            "location": data["lives"][0]["province"] + " " + data["lives"][0]["city"],
